	...
	***						                                  ***
			               ...
			               „Imoen 4 Ever"
			dla BG:EE, BGII, BGT, BGII:EE, oraz EET
					by jastey 
...
Wypakuj zawartoœæ archiwum moda do g³ównego katalogu gry. Rodzaj gry zostanie rozpoznany automatycznie i zainstalowana zostanie odpowiednia zawartoœæ.
...
Windows
Po pomyœlnym wypakowaniu archiwum w folderze gry powinien pojawiæ siê folder „imoen_forever" oraz plik „setup-imoen_forever.exe". Aby zainstalowaæ moda, nale¿y uruchomiæ plik .exe i postêpowaæ zgodnie z instrukcjami na ekranie.
Ponowne uruchominie „setup-imoen_forever.exe" w folderze gry, pozwoli odinstalowaæ lub przeinstalowaæ modyfikacjê.

Nie ma jeszcze wersji Mac OS X ani Linux, ale jeœli wiesz jak, to mo¿esz sam stworzyæ odpowiedni¹ instalacjê, u¿ywaj¹c folderu moda.


UWAGA: 
BG (II): EE s¹ ca³y czas aktywnie wspierane. Nale¿y pamiêtaæ, ¿e ka¿da aktualizacja gry usunie wszystkie zainstalowane mody! Warto opóŸniæ aktualizacjê, jeœli zamierzasz dokoñczyæ rozpoczêt¹ grê z modami, gdy¿ czasami nawet ich przeinstalowanie nie pozwoli Ci wróciæ do starych zapisów.
Jeœli bêdziesz mieæ problemy z instalacj¹ lub napotkasz jakieœ b³êdy, opublikuj swój raport o b³êdach w jednym z w¹tków na forum, w których znalaz³eœ ten mod.
...
---------
Po jeszcze wiêcej uwag dla modderów odsy³am do angielskiego readme (memory).
